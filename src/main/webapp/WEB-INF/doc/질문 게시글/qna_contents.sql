...
-- Create, 등록: 1건 이상
INSERT INTO QNA_CONTENTS(qcon_no, cate_no, pro_no, qcon_name, qcon_contents, qcon_views, qcon_bookmark, qcon_comment, qcon_date, 
                        word, pro_pw)
VALUES(qna_contents_seq.nextval, 2, 1, '찾아주세요!', '사진 속 물건과 비슷한게 있을까요?', 0, 0, 0, sysdate, '질문', '1111');

INSERT INTO QNA_CONTENTS(qcon_no, cate_no, pro_no, qcon_name, qcon_contents, qcon_views, qcon_bookmark, qcon_comment, qcon_date, word)
...
-- 전체 목록
SELECT qcon_no, cate_no, pro_no, qcon_name, qcon_contents, qcon_views, qcon_bookmark, qcon_comment, qcon_date
FROM qna_contents
...
SELECT qcon_no, cate_no, pro_no, qcon_name, qcon_contents, qcon_views, qcon_bookmark, qcon_comment, qcon_date, word
FROM qna_contents
