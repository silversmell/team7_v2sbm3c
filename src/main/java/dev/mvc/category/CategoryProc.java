...
public class CategoryProc implements CategoryProcInter {
  ...
  public CategoryVO read(int cate_no) {
    CategoryVO categoryVO = this.categoryDAO.read(cate_no);
    return categoryVO;
  }
  
  @Override
  public int delete(int cate_no) {
    int cnt = this.categoryDAO.delete(cate_no);
    return cnt;
  }
  
  @Override
  public int update_seqno_forward(int cate_no) {
    int cnt = this.categoryDAO.update_seqno_forward(cate_no);
    return cnt;
  }
  
  @Override
  public int update_seqno_backward(int cate_no) {
    int cnt = this.categoryDAO.update_seqno_backward(cate_no);
    return cnt;
  }
  
  @Override
  public int update_visible_y(int cate_no) {
    int cnt = this.categoryDAO.update_visible_y(cate_no);
    return cnt;
  }
  
  @Override
  public int update_visible_n(int cate_no) {
    int cnt = this.categoryDAO.update_visible_n(cate_no);
    return cnt;
  }
  
  @Override
  public ArrayList<CategoryVO> list_all_cate_name() {
      // 특정 카테고리명에 해당하는 카테고리 목록 로딩
      ArrayList<CategoryVO> list = this.categoryDAO.list_all_cate_name();
      return list;
  }
  ...
  public ArrayList<CategoryVOMenu> menu() {
      ...
      for (CategoryVO categoryVO : list) {
          CategoryVOMenu categoryVOMenu = new CategoryVOMenu(); // 하나의 메뉴 그룹
          
          categoryVOMenu.setCate_name(categoryVO.getCate_name()); // 카테고리명
