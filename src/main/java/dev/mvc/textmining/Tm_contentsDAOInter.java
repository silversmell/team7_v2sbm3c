...
public interface Tm_contentsDAOInter {
   ...
   * @return
   */
  public ArrayList<Tm_contentsVO> list_by_qna_search(HashMap<String, Object> hashMap);
   ...
   * @return
   */
  public ArrayList<Tm_contentsVO> list_by_qna_search_paging(HashMap<String, Object> hashMap);
