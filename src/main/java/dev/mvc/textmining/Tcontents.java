...
public class Tcontents {
    ...
    public static synchronized String getUploadDir() {
        ...
        if (File.separator.equals("\\")) { // windows, 개발 환경의 파일 업로드 폴더
            // path = "C:/kd/deploy/textmining/qcontents/storage";
           path="C:\\kd\\deploy\\team7\\textmining\\storage\\";
           System.out.println("Windows 10: " + path);
           
        } else { // Linux, AWS, 서비스용 배치 폴더 
            // System.out.println("Linux");
            path = "/home/ubuntu/deploy/team7/textmining/storage/";
        }
    ...
    // Windows, VMWare, AWS cloud 절대 경로 설정
    public static synchronized String getUploadDirAccProfile() {
        String path = "";
